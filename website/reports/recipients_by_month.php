...
if(is_null(getReport('getBTCValue'))) {
    $res->message = "<p class='recipients-data-header overview-hint'>Currently collected in <span id='overview-recipients_option'></span> <span id='overview-id' style=\"color:black;float:right;\">Generation date <span>".$res->date."</span></span></p>";
